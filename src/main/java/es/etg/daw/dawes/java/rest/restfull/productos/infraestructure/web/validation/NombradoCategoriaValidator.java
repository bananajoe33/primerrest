...
public class NombradoCategoriaValidator implements ConstraintValidator<NombradoCategoria, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        /* Vamos a validar el campo categoría aplicando las siguientes normas:
